...
import * as C from './Components/061/constants';

import * as A from './Components/061/actions';
...
function App() {
    ...
    return (
        <>
            ...
            <div className="shape-control">
                <button className="blue" onClick={_ => dispachShape(A.changeSize(size))}>Keisti dydį</button>
